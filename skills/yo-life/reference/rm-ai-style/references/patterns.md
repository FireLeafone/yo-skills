...
> 本文件是 **pattern detail reference**。SKILL.md 的第 2 步("扫描 AI 模式")告诉你该激活哪些规则子集(按语体矩阵),本文件给出核心 A-G/I 规则的完整定义 + 原文改后对照 + 语体限定 + 跨规则 interlock。
>
> H 组平台 / 文体规则(#37/#38/#49/#50)已拆到 [platform-patterns.md](platform-patterns.md),避免单个参考文件过长。其余规则仍保留在本文件;跨组例外通过显式链接维护。
>
> **阅读路径:** 按语体矩阵激活的子集,从上往下读(A → I)。叙事非虚构 / 特稿注意保护有意排比与铺垫;小说 / 虚构文学语体下 H 组只需读 #38。
...
> ⚠️ **语体限定：** 政府报告、企业战略宣导等庄重正式文本里，"具有重要意义""标志着新阶段""发挥重要作用"就是**规定动作和规范表达**,不是 AI 腔。一律删改会破坏文本应有的庄重感。本规则只在**日常 / 自媒体 / 博客 / 书面**语体里触发；庄重正式文本**不触发**。
...
**原文：**
> 这个设计体现了团队对用户体验的深刻思考，彰显了其在行业中的领先地位。
...
> ⚠️ **语体限定（重要）：**
> - **规范书面语里**，`进行 + V` 是**规范表达**,标志动作的过程性和庄重度 —— `进行尽职调查`、`进行听证`、`对该政策进行研究` 都是合法、不可替换的刚需结构。**少量出现不改。**
> - **日常 / 社交 / 自媒体** 语体里，单次用没问题；但**短段落内（约 100 字）密集出现 ≥ 2 次**,就是机械书面化，可以改。
...
> - 以上这些是**科技 / 工程语境的规范术语**,不是"AI 把形容词名词化"的痕迹。凡在论文、技术报告、白皮书、科普文章里出现，一律保留。
>
> ⚠️ **语体限定：**
> - **科技 / 工程语境**:不改。这些术语是精确表达。
> - **日常 / 自媒体 / 书面** 语体里密集出现上述白名单**之外**的 `全面性 / 前瞻性 / 战略性 / 时代性` 等**不带具体指涉**的抽象名词（换成任何话题都能用、删掉不丢意思），才是 AI 腔。

**原文（书面 / 一般语体机械堆叠、非白名单词):**
...
> ⚠️ **语体分层触发阈值：**
>
> - **日常 / 自媒体 / 社交 / 邮件 / PRD 语体**: 短段（<300 字）出现 **≥ 2 次**同位补注即触发,不再要求 Y 空转。真人在这些语体里基线就是 0 次。
> - **书面 / 一般** 语体: 短段（<300 字）出现 **≥ 3 次**触发,单次合法同位补注保留。
> - **杂文 / 特稿 / 叙事非虚构** 语体: 维持旧阈值 `≥3 次 且 Y 是空转解释`,保护鲁迅 / 钱钟书 / 董桥 / 王小波式补注。
>
...
> ⚠️ **语体限定：** 规范书面语里逻辑连接词必要 —— 但**空转**的仍要改（全文只有三段，却用"综上所述，本研究..." 收束）。
...
- 口号式标语（如果是原文引用的现成 slogan,属于"信息完整性",保留）
...
> ⚠️ **语体分层触发:**
> - **日常 / 自媒体 / 社交 / 邮件 / PRD**: 500 字内 **≥ 2 处**不承担明确功能的 `——` 即触发。真人在这些语体里基线是 0。
> - **书面 / 一般 / 博客**: 500 字内 **≥ 3 处**不承担明确功能的 `——` 即触发。
> - **杂文 / 特稿 / 叙事非虚构**: 维持"每段都来一个且都不承担功能"的旧阈值。破折号在这些语体里是合法节奏工具。**小说 / 虚构文学**里，对话中表示被打断的 `——` 承担叙事功能，不触发。
...
> ⚠️ **保护示范（不要误伤）：** 鲁迅、钱钟书、董桥等人杂文里的破折号**承担明确修辞功能**（转折 / 强调 / 具体化补注）,是示范,不是反面教材。改前必做自查问：这个 `——` 承担了具体的**转折 / 强调 / 同位补注（带新信息的 Y）** 功能吗？承担了就保留，只删"可无损替换成其他标点"的那些。
...
- ✅ 触发：社交、自媒体、工作邮件、书面随笔、特稿、CEO / 领导层公开信、产品公告
...
> ⚠️ **语体限定：** 法律、合同等规范书面文本里 `关于 X 的问题 / 在 X 情况下 / 由于 X 的原因` 可能是必要精确度，**不改**。
...
> ⚠️ **语体限定：** 小说 / 虚构文学语体里，人物名的叙事性重复不触发。
...
- **主体占位(裸露方括号 / 尖括号):** `[产品名] / [公司名] / [作者] / <书名> / {{变量}}`
